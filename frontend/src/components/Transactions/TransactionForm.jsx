...
const TransactionForm = () => {
  ...
  // Log fetched data to debug API response shape
  useEffect(() => {
    console.log("Categories data:", data);
  }, [data]);

  // Log any query or mutation errors to help pinpoint issues
  useEffect(() => {
    if (isError) {
      console.error("Error loading categories:", error);
    }
    if (isAddTranErr) {
      console.error("Error adding transaction:", transErr);
    }
  }, [isError, error, isAddTranErr, transErr]);
    ...
    onSubmit: (values) => {
      ...
      mutateAsync(values)
        .then((data) => {
          ...
          navigate("/add-transaction"); // Adjust navigation as needed
        })
        .catch((e) => console.error("Error on submission:", e));
    },
  });
