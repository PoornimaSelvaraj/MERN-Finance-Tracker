...
const RegistrationForm = () => {
  ...
  return (
    <div className="max-w-md mx-auto my-10">
      ...
      {/* Alert Messages */}
      {isPending && <AlertMessage type="loading" message="Registering you..." />}
      {isError && (
        <AlertMessage
          type="error"
      ...
      {/* Render form only if registration is not successful */}
      {!isSuccess && (
        <form
          onSubmit={formik.handleSubmit}
          className="bg-white p-6 rounded-xl shadow-lg space-y-6 border border-gray-200 mt-4"
        >
          {/* Username */}
